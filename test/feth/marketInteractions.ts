...
import { FETH, FETHMarketMock, FETHMarketMock__factory } from "../../src/typechain";
...
describe("FETH / marketInteractions", function () {
  ...
  snapshotEach(async () => {
    ...
    feth = await deployFETH({ deployer, marketAddress: mockMarket.address, dropMarketAddress: mockMarket.address });
